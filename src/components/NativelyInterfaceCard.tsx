        ...
        {!hidePill && (
          ...
          >
            ...
            <div className="w-8 h-8 rounded-full flex items-center justify-center relative overflow-hidden" style={DARK_GLASS}>
              {GLOSS}
              <img src={nativelyLogo} alt="Hintily" className="w-[28px] h-[28px] object-contain relative" draggable={false} />
            </div>
            ...
            <div className="relative">
              ...
              >
                {dreamyVariant ? (
                  ...
                  "Ask anything — Hintily knows your resume and this company..."
                )}
              </div>
            </div>
